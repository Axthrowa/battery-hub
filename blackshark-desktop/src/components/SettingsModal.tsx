      ...
      >
              ...
              return (
                <button
                  ...
                  className={`rounded-xl border px-3 py-2.5 text-sm transition ${
                    active
                      ? "border-razer/60 bg-razer/15 text-razer"
        ...
        <section className="rounded-xl border border-white/10 bg-ink-800 p-3.5">
          <label className="flex cursor-pointer items-center justify-between gap-3">
            ...
            <span className="relative inline-flex shrink-0">
              ...
              />
              <span className="h-6 w-11 rounded-full bg-ink-700 transition peer-checked:bg-razer/70" />
        ...
        <footer className="mt-5">
          <button
            type="button"
            onClick={onClose}
            className="w-full rounded-xl bg-razer/90 py-2.5 text-sm font-semibold text-black transition hover:bg-razer"
          >
            {t("close")}
          </button>
        </footer>
